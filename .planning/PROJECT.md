...
- [ ] Дашборд с общей статистикой: всего лицензий, истекает скоро, уже истекло
- [ ] Таблица лицензий с фильтрацией и сортировкой
- [ ] Цветовая подсветка строк по статусу: красный (истекло / критично), жёлтый (скоро), зелёный (активно)
- [ ] Виджет «Скоро истекающие» на главной странице
