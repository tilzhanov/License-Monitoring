...
- [x] **LIC-06**: Порог «скоро истекает» задаётся глобально (по умолчанию 30 дней) и может быть переопределён для отдельной лицензии
...
- [x] **SETT-02**: Кнопка «Отправить тестовое уведомление» для проверки конфигурации
